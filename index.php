...
<a href="<?php echo home_url ('/liste');?>"><button class='glowing-btn'><span class='glowing-txt'>C<span class='faulty-letter'>liquez</span> ici sgdjnygrf,jnrfyhvous n'êtes pas un mouton</span></button></a>
